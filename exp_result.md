...
Run cost: 13,002,568 tokens, $33.8512. Reproduce: `./.venv/bin/python scripts/run_per_user_eval.py --user fiona,chang --train-frac 0.15 --val-frac 0.42 --budget 5` (from annotagent/backend).
